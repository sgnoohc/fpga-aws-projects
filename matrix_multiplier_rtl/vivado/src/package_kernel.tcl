...
proc edit_core {core} {
  ...
  set reg      [::ipx::add_register -quiet "nrows_A" $addr_block]
  set_property address_offset 0x010 $reg
  set_property size           4   $reg

  set reg      [::ipx::add_register -quiet "ncols_A" $addr_block]
  set_property address_offset 0x018 $reg
  set_property size           4   $reg

  set reg      [::ipx::add_register -quiet "ncols_B" $addr_block]
  set_property address_offset 0x020 $reg
  set_property size           4   $reg

  set reg      [::ipx::add_register -quiet "in_A" $addr_block]
  set_property address_offset 0x028 $reg
  set_property size           8   $reg

  set reg      [::ipx::add_register -quiet "in_B" $addr_block]
  set_property address_offset 0x030 $reg
  set_property size           8   $reg

  set reg      [::ipx::add_register -quiet "out_C" $addr_block]
